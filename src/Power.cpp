...
// If using internal pull resistors, we can infer EXT_PWR_DETECT_VAL
#elif EXT_PWR_DETECT_MODE == INPUT_PULLUP
#define EXT_PWR_DETECT_VAL LOW
#elif EXT_PWR_DETECT_MODE == INPUT_PULLDOWN
#define EXT_PWR_DETECT_VAL HIGH
#endif
#ifndef EXT_PWR_DETECT_VAL
#define EXT_PWR_DETECT_VAL HIGH
#endif
#endif
...
#define BATTERY_SENSE_SAMPLES                                                                                                    \
    ...
    {
#ifdef EXT_PWR_DETECT
        return digitalRead(EXT_PWR_DETECT) == EXT_PWR_DETECT_VAL;
