...
const RegionInfo regions[] = {
    ...
    */
    RDEF(MY_433, 433.0f, 435.0f, 100, 0, false, false, PROFILE_STD),
    ...
    /*
        ...
        Note: MY Tx power limit removed for my_hams branch. Not for general and/or unlicensed use.
    */
    RDEF(MY_919, 919.0f, 924.0f, 100, 0, true, false, PROFILE_STD),
...
void RadioInterface::applyModemConfig()
{
    ...
    if (power == 0)
        power = INT8_MAX; // Default to this power level if we don't have a valid regional power limit (powerLimit of myRegion
                          // defaults to 0, currently no region has an actual power limit of 0 [dBm] so we can assume regions
                          // which have this variable set to 0 don't have a valid power limit)
